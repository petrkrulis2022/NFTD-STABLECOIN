          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-[1.875rem] lg:grid-cols-5">
              <div className="dark:bg-jacarta-700 rounded-2lg dark:border-jacarta-600 border-jacarta-100 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                <img
                  src="img/team/arin-dewangan.jpg"
                  className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-[1.25rem]"
                  alt="team"
                />
                <h3 className="font-display text-jacarta-700 text-[1.125rem] dark:text-white">
                  Arin Dewangan
                </h3>
                ...
                <div className="mt-3 flex justify-center space-x-5">
                  <a
                    href="https://linkedin.com/in/arin-dewangan"
                    className="group"
                  >
                    <svg
                      aria-hidden="true"
                  ...
                  <a href="https://twitter.com/arindewangan" className="group">
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
              ...
              <div className="dark:bg-jacarta-700 rounded-2lg dark:border-jacarta-600 border-jacarta-100 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                <img
                  src="img/team/memo-allocates.jpg"
                  className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-[1.25rem]"
                  alt="team"
                />
                <h3 className="font-display text-jacarta-700 text-[1.125rem] dark:text-white">
              ...
              <div className="dark:bg-jacarta-700 rounded-2lg dark:border-jacarta-600 border-jacarta-100 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                <img
                  src="img/team/peter-todorov.png"
                  className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-[1.25rem]"
                  alt="team"
                />
                <h3 className="font-display text-jacarta-700 text-[1.125rem] dark:text-white">
              ...
              >
                <span className="font-display text-jacarta-700 text-[1.125rem] dark:text-white">
                  Join us!
                </span>
              </a>
            </div>
